    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    @foreach (\App\Models\Cloth::all() as $cloth)
                        <a class="dropdown-item" href="/cloth/{{ $cloth->id }}">{{ $cloth->name }}</a>
                    @endforeach

                    <div class="dropdown-divider"></div>

                    <a type="button" class="dropdown-item" href="/cloth">Roupas</a>
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    @foreach (\App\Models\Beer::all() as $beer)
                        <a class="dropdown-item" href="/beer/{{ $beer->id }}">{{ $beer->name }}</a>
                    @endforeach

                    <div class="dropdown-divider"></div>

                    <a type="button" class="dropdown-item" href="/beer">Cervejas</a>
